...
public class FileUtils {
    ...
    public static final String DATA_BASEDIR =null;
    /*PropertyUtils.getString(Constants.DATA_BASEDIR_PATH,"/tmp/dolphinscheduler")*/;
...
/*        OSUtils.taskLoggerThreadLocal.set(taskLoggerThreadLocal.get());
     ...
     * find filedir names
     */
    public static void  findFileALL(File file, ArrayList<String> list,ArrayList<String> dirLists) {
        if (file.exists()) {
            ...
            if (null != files) {
                for (File file2 : files) {
                    if (file2.isDirectory()) {
                        ...
                        dirLists.add(path);
                        findFileALL(file2,list,dirLists);
                    } else {

 ...
 */
package necibook.com.dolphinscheduler.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import necibook.com.entity.dsentity.Schedule;
...
public interface ScheduleMapper extends BaseMapper<Schedule> {
     ...
     * @return schedule list
     */
    List<Schedule> queryByProcessDefinitionId(@Param("processDefinitionId") Integer processDefinitionId);
     ...
     * @param startTime 调度时间范围起始时间
     * @param endTime 调度时间范围结束时间
     * @return schedule
     */
    Schedule queryByProcessDefinitionIdAndTime(@Param("processDefinitionId") int processDefinitionId , @Param("startTime") String startTime, @Param("endTime") String endTime);

    String queryReleaseStateByScheduleId(@Param("scheduleId") int scheduleId);
}
